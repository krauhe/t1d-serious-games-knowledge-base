...
<div class="layout"><nav aria-label="Report contents"><strong>CONTENTS</strong>${nav}</nav><main>${body}<footer>End of report. Dated finding statuses distinguish implemented corrections from residual work; source-verification limits are specified above.</footer></main></div></body></html>`;
