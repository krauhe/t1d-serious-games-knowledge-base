# Full-Text Access Wishlist

**Scope:** Serious games, gamification, simulations, and related physiological, educational and implementation-science sources used in this knowledge base, with priority given to type 1 diabetes (T1D).

**Last checked:** 6 September 2026; individual attempts are recorded in the audit access register.

**Purpose:** Sources for which a stable, lawfully accessible full text could not be verified. These records may be revisited through institutional library access, interlibrary loan, or direct author contact.

This list includes subscription barriers, unsuccessful open-access retrievals and unresolved publication identities; these are not interchangeable. Lawful private access and permission to redistribute a publication are separate questions. Missing permission to republish is not, by itself, a reason to reject a lawfully accessible reading copy.
...
|---:|---|---|---|---|
| 1 | Brown et al. (1997), *Educational video game for juvenile diabetes: Results of a controlled trial* | [DOI 10.3109/14639239709089835](https://doi.org/10.3109/14639239709089835); [PMID 9183781](https://pubmed.ncbi.nlm.nih.gov/9183781/) | Abstract verified. Publisher full text was not acquired; the discovered author-upload route returned HTTP 403 locally on 6 September 2026. | Six-month randomised controlled evaluation of *Packy & Marlon*; foundational evidence for behaviour, communication, self-efficacy, clinical utilisation, knowledge, and glycated haemoglobin outcomes. |
| 2 | D'Aprile, Ligorio and Ulloa Severino (2019), *How Serious Games for Health Enhance Empowerment-Related Patient Education: The Impact of Gender* | [DOI 10.1007/s10758-017-9344-x](https://doi.org/10.1007/s10758-017-9344-x) | Springer full text access restricted; abstract and metadata are public. | Evaluation of *Tako Dojo* with 124 adolescents; important for empowerment, adherence, gender, and social learning. |
...
| Peters et al. (2019), *Usability of the PAL Objectives Dashboard for Children's Diabetes Self-Management Education* | [DOI 10.1145/3312714.3312736](https://doi.org/10.1145/3312714.3312736) | Full text not acquired through the tested publisher/repository routes. A previously identified author-upload lead still requires retrieval. | Institutional ACM access or author request. |
...
| Pesare, Roselli and Rossano (2015), *Intelligent Agent and Virtual Game to Support Education in E-Health* | [DOI 10.18293/DMS2015-035](https://doi.org/10.18293/DMS2015-035); [University of Bari record](https://hdl.handle.net/11586/188854) | Bibliographic record verified; full text was not acquired from the tested publisher/repository routes. A previously identified author-upload lead remains unresolved. | Contact the authors or request the DMS 2015 proceedings through a library. |
| Moosa, Al-Maadeed and AlJa'am (2018), *A Simple Health-Based Game for Children* | [DOI 10.1109/COMAPP.2018.8460213](https://doi.org/10.1109/COMAPP.2018.8460213) | IEEE full text access restricted. | Institutional IEEE Xplore access or author request. |
...
3. Recheck trusted repositories for later open-access versions, corrections, or supplementary material.
